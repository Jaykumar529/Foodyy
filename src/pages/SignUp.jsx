...
const SignUp = ({ onClose, onSwitch, onLoginSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Signup failed. mail address is already exist. Try again.");
    }
  };
  ...
  return (
    <StyledWrapper className="fixed inset-0 flex items-center justify-center px-4 bg-black bg-opacity-30 backdrop-blur-sm z-50">
      <form
      ...
      >
        ...
        <div className="form-body">
          ...
          <div className="input-group">
            <div className="input-wrapper">
              ...
              />
              <button
                className="password-toggle h-6 w-6"
                type="button"
        ...
        <div className="form-footer mt-4" onClick={onSwitch}>
